...
abstract class AbstractEmergentItqPainterCache {
  ...
  AbstractEmergentItqPainterCache();
  ...
  bool updateShadowColor({
    required Color newShadowLightColorItq,
    required Color newShadowDarkColorItq,
    ...
    if (invalidateIntensity ||
        _styleShadowLightColor != newShadowLightColorItq) {
      _styleShadowLightColor = newShadowLightColorItq;
      _shadowLightColor = generateShadowLightColor(
          color: newShadowLightColorItq, intensity: newIntensity);

      invalidate = true;
    }
    //dark
    if (invalidate || _styleShadowDarkColor != newShadowDarkColorItq) {
      _styleShadowDarkColor = newShadowDarkColorItq;
      _shadowDarkColor = generateShadowDarkColor(
        color: newShadowDarkColorItq,
