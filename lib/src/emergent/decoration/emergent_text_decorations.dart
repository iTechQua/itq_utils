...
import 'package:itq_utils/src/emergent/decoration/emergent_text_decoration_painter.dart';
...
class EmergentTextDecoration extends Decoration {
  ...
  EmergentTextDecoration? lerpFrom(Decoration? a, double t) {
    ...
    if (a is EmergentTextDecoration) {
      return EmergentTextDecoration.itqlErp(a, this, t);
    }
  ...
  EmergentTextDecoration? lerpTo(Decoration? b, double t) {
    ...
    if (b is EmergentTextDecoration) {
      return EmergentTextDecoration.itqlErp(this, b, t);
    }
  ...
  static EmergentTextDecoration? itqlErp(
