...
import 'package:itq_utils/src/emergent/emergent_box_shape.dart';
import 'package:itq_utils/src/emergent/theme/emergent_decoration_theme.dart';
import 'cache/emergent_itq_painter_cache.dart';

class EmergentItqDecorationPainter extends BoxPainter {
  final EmergentItqPainterCache _cache;
  ...
  EmergentItqDecorationPainter(
      ...
      : shape = shape ?? const EmergentBoxShape.rect(),
        _cache = EmergentItqPainterCache(),
        super(onChanged) {
    _generatePainters();
  }
  ...
  void _updateCache(
    ...
    final bool invalidateShadowColors = _cache.updateShadowColor(
      newShadowLightColorItq:
          style.shadowLightColorItq ?? const Color(0xFFFFFFFF),
      newShadowDarkColorItq: style.shadowDarkColorItq ?? const Color(0xFF000000),
