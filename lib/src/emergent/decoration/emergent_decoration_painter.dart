...
import 'package:itq_utils/src/emergent/decoration/cache/emergent_painter_cache.dart';
import 'package:itq_utils/src/emergent/decoration/emergent_box_decoration_helper.dart';
import 'package:itq_utils/src/emergent/emergent_box_shape.dart';
import 'package:itq_utils/src/emergent/emergent_shape.dart';
  ...
  void _updateCache(Offset offset, ImageConfiguration configuration) {
    ...
    if (style.shadowLightColor != null &&
      ...
      invalidateShadowColors = _cache.updateShadowColor(
        newShadowLightColorItq: style.shadowLightColor!,
        newShadowDarkColorItq: style.shadowDarkColor!,
