...
class EmergentThemeData {
  ...
  final Color shadowLightColorItq;
  final Color shadowDarkColorItq;
  ...
  const EmergentThemeData({
    ...
    this.shadowLightColorItq = EmergentColors.itqMaxWhiteColor,
    this.shadowDarkColorItq = EmergentColors.itqMaxDarkColor,
  ...
  bool operator ==(Object other) =>
      ...
      other is EmergentThemeData &&
          ...
          shadowDarkColorItq == other.shadowDarkColorItq &&
          shadowLightColorItq == other.shadowLightColorItq &&
  ...
  int get hashCode =>
      ...
      shadowDarkColorItq.hashCode ^
      shadowLightColorItq.hashCode ^
  ...
  EmergentThemeData copyWith({
    ...
    Color? shadowLightColorItq,
    Color? shadowDarkColorItq,
    ...
    return EmergentThemeData(
      ...
      shadowDarkColorItq: shadowDarkColorItq ?? this.shadowDarkColorItq,
      shadowLightColorItq: shadowLightColorItq ?? this.shadowLightColorItq,
      depth: depth ?? _depth,
...
class EmergentStyle {
  ...
  const EmergentStyle({
    ...
    this.shadowLightColorItq,
    this.shadowDarkColorItq,
    double? depth,
    double? intensity,
  ...
  EmergentStyle copyWithThemeIfNull(EmergentThemeData theme) {
    return EmergentStyle._withTheme(
        ...
        shadowDarkColorItq: shadowDarkColorItq ?? theme.shadowDarkColorItq,
        shadowLightColorItq: shadowLightColorItq ?? theme.shadowLightColorItq,
