...
import 'package:itq_utils/src/emergent/decoration/emergent_decorations.dart';
import 'package:itq_utils/src/emergent/widget/clipper/emergent_box_shape_clipper.dart';
...
///
/// if [EmergentStyle.depth] < 0 ----> use the itq shape
///
/// The container animates any change for you, with [duration] ! (including style / theme / size / etc.)
///
/// [drawSurfaceAboveChild] enable to draw itq, concave, convex effect above this widget child
///
...
///   put an image inside a emergent(itq) :
///   drawSurfaceAboveChild=false -> the itq effect is below the image -> not visible
///   drawSurfaceAboveChild=true -> the itq effeect effect is above the image -> visible
///
@immutable
