...
import 'package:itq_utils/src/emergent/widget/animation/emergent_animated_scale.dart'
    as animation_scale;
...
class EmergentSwitch extends StatelessWidget {
  ...
  double? _getTrackDepth(double? themeDepth) {
    ...
    //force negative to have itq
    final double depth = -1 * (style.trackDepth ?? themeDepth).abs();
    return depth.clamp(Emergent.minDepth, EmergentSwitch.minItqDepth);
  }
