...
import 'package:itq_utils/src/dropdown_search/widgets/popup_menu.dart';
import 'package:itq_utils/src/dropdown_search/widgets/selection_widget.dart';
...
typedef DropdownSearchFilterFunction<T> = bool Function(T item, String filter);
typedef DropdownSearchCompareFunction<T> = bool Function(T item1, T item2);
...
class DropdownSearch<T> extends StatefulWidget {
  ...
  final DropdownSearchFilterFunction<T>? filterFn;

  ///enable/disable dropdownSearch
  final bool enabled;

  ///function that compares two object with the same type to detected if it's the selected item or not
  final DropdownSearchCompareFunction<T>? compareFn;
